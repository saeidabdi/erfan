    ...
    <div class="div col-lg-9 left">
        ...
        <div class="col-md-12" v-if="!order_id" style="padding-top: 30px;">
            <ul class="ul_allorder">
                <li class="order_item" v-for="order in all_order" v-if="order.status == 4">
                    ...
                    <div class="left">
                        <button v-if="order.status == 4" @click="get_inorder(order.id,order.title)" type="button" class="btn btn-info">نمایش</button>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-12" v-if="order_id" style="padding-top: 10px;">
            ...
            <div class="col-md-6 left">
                ...
                <div class="all_price">
                    <button v-if="order[0].status == 1" type="button" class="btn btn-success">پرداخت</button>
                </div>
            </div>
